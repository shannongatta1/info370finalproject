...
Among 811 democratic candidates, 265 of them advanced in the recent primary and the rate of winning the primary was **32.7%**. As mentioned above, we got rid of five columns and created a new column which was the month of the election. The table below shows the details of the variables we included in our dataset. 
```{r, echo=FALSE, message = FALSE}
...
```{r}
library(vcd)
mosaic(Primary.Status ~ Race + Veteran. , data = dems, shade=TRUE)
```
